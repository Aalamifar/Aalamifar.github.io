    ...
    var t = {
            ...
            t.exports = function(t, e, n, u, a, c) {
                ...
                c.set(e, t); ++h < l; ) {
                    var y = t[h]
                      , E = e[h];
                    if (u)
                        var m = s ? u(E, y, h, e, t, c) : u(y, E, h, t, e, c);
                    if (void 0 !== m) {
                        if (m)
                            continue;
                        v = !1;
            ...
            t.exports = function(t, e, n, o, u, a) {
                ...
                for (var g = c; ++f < l; ) {
                    var y = t[d = s[f]]
                      , E = e[d];
                    if (o)
                        var m = c ? o(E, y, d, e, t, a) : o(y, E, d, t, e, a);
                    if (!(void 0 === m ? y === E || u(y, E, n, o, a) : m)) {
                        v = !1;
                        break
                    }
                    g || (g = "constructor" == d)
                ...
                if (v && !g) {
                    var _ = t.constructor
                      , b = e.constructor;
                    _ != b && "constructor"in t && "constructor"in e && !("function" == typeof _ && _ instanceof _ && "function" == typeof b && b instanceof b) && (v = !1)
                }
                return a.delete(t),
                a.delete(e),
                v
        ...
        9937: function(t, e, n) {
            var r = n(8172)
              ...
              , m = s(a)
              , _ = c;
            (r && _(new r(new ArrayBuffer(1))) != h || i && _(new i) != l || o && _(o.resolve()) != f || u && _(new u) != d || a && _(new a) != p) && (_ = function(t) {
                var e = c(t)
        ...
        1185: function(t, e) {
                    ...
                    if (null != v) {
                        ...
                        if (g.length)
                            for (var y = 0; y <= g.length; y++) {
                                ...
                                if (!t || void 0 === u[E]) {
                                    var m = v[E];
                                    e && s(u[E]) && s(m) && (m = c(t, e, u[E], m)),
                                    void 0 !== m && m !== u[E] && (!l && (l = !0,
                                    u = a(u)),
                                    u[E] = m)
                                }
                            }
            ...
            function I(t, e, n, r, i, o, u) {
                ...
                for (var s = void 0, l = arguments.length, f = Array(l > 7 ? l - 7 : 0), d = 7; d < l; d++)
                    f[d - 7] = arguments[d];
                return m(t, e, s = f.length ? c.call.apply(c, [null, !1, !1, a, n, r, i, o, u].concat(f)) : c(!1, !1, a, n, r, i, o, u))
            }
            function T(t, e) {
            ...
            window.tram = function(t) {
                ...
                function o(t, e, n) {
                    ...
                    void 0 === t)
                        return n;
                    var r = n;
                    return q.test(t) || !K.test(t) ? r = parseInt(t, 10) : K.test(t) && (r = 1e3 * parseFloat(t)),
                    0 > r && (r = 0),
                    r == r ? r : n
                }
                function u(t) {
                ...
                }, p = window, h = "bkwld-tram", v = /[\-\.0-9]/g, g = /[A-Z]/, y = "number", E = /^(rgb|#)/, m = /(em|cm|mm|in|pt|pc|px)$/, _ = /(em|cm|mm|in|pt|pc|px|%)$/, b = /(deg|rad|turn)$/, w = "unitless", O = /(all|none) 0s ease 0s/, I = /^(width|height)$/, T = document.createElement("a"), A = ["Webkit", "Moz", "O", "ms"], S = ["-webkit-", "-moz-", "-o-", "-ms-"], C = function(t) {
                    if (t in T.style)
                        return {
                            dom: t,
                            css: t
                ...
                if (x.transition) {
                    var F = x.timing.dom;
                    if (T.style[F] = f["ease-in-back"][0],
                    !T.style[F])
                        for (var N in d)
                            f[N][0] = d[N]
                }
                var R = e.frame = (a = p.requestAnimationFrame || p.webkitRequestAnimationFrame || p.mozRequestAnimationFrame || p.oRequestAnimationFrame || p.msRequestAnimationFrame) && x.bind ? a.bind(p) : function(t) {
                    p.setTimeout(t, 16)
                }
                  , P = e.now = (s = (c = p.performance) && (c.now || c.webkitNow || c.msNow || c.mozNow)) && x.bind ? s.bind(c) : Date.now || function() {
                    return +new Date
                }
                  , L = l(function(e) {
                    function n(t, e) {
                    ...
                    e.init = function(e) {
                        ...
                        x.backface && X.hideBackface && W(this.el, x.backface.css, "hidden")
                    }
                    ,
                    y("add", n),
                    y("start", r),
                  ...
                  , j = l(function(t) {
                    ...
                    t.init = function(t, e, r, u) {
                        ...
                        this.unit = u.unit || this.unit || X.defaultUnit,
                        this.angle = u.angle || this.angle || X.defaultAngle,
                        X.fallback || u.fallback ? this.animate = this.fallback : (this.animate = this.transition,
                ...
                x.transform && x.backface && (Y.z = [_, "translateZ"],
                Y.rotateZ = [b],
                Y.scaleZ = [y],
                Y.perspective = [m]);
                var q = /ms/
        ...
        5756: function(t, e, n) {
            "use strict";
            var r, i, o, u, a, c, s, l, f, d, p, h, v, g, y, E, m, _, b, w, O = window.$, I = n(5487) && O.tram;
            ...
            r.template = function(t, e, n) {
                ...
                t.replace(o, function(e, n, r, i, o) {
                    return a += t.slice(u, o).replace(_, b),
                    u = o + e.length,
                ...
                /*n.ready = function() {
                    ...
                    n && !c && (e = e || function() {
                        var e = t('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs")
                          ...
                          , r = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-text-d2.c82cec3b78.svg").attr("alt", "Made in Webflow");
                        return e.append(n, r),
                        e[0]
                    }(),
                    f(),
                            ...
                            success: function(e) {
                                return function(n) {
                                    ...
                                    function(e, n) {
                                        ...
                                        return t.indexOf("//") >= 0 ? t : p("https://editor-api.webflow.com" + t)
        ...
        3949: function(t, e, n) {
            ...
            _ && f.on("touchstart mousedown", function(t) {
                r = t.target
            }),
            o.validClick = _ ? function(t) {
        ...
        6524: function(t, e) {
            "use strict";
            function n(t, e, n, r, i, o, u, a, c, s, l, f, d) {
                return function(p) {
                    t(p);
                    var h = p.form
                      , v = {
        ...
        7527: function(t, e, n) {
            ...
            r.define("forms", t.exports = function(t, e) {
                let o;
                let u = "TURNSTILE_LOADED";
                var a, c, s, l, f, d = {}, p = t(document), h = window.location, v = window.XDomainRequest && !window.atob, g = ".w-form", y = /e(-)?mail/i, E = /^\S+@\S+$/, m = window.alert, _ = r.env();
                ...
                d.ready = d.design = d.preview = function() {
                    (function() {
                        b && ((o = document.createElement("script")).src = "https://challenges.cloudflare.com/turnstile/v0/api.js",
                    ...
                    function() {
                        if (l = "https://webflow.com/api/v1/form/" + (c = t("html").attr("data-wf-site")),
                        v && l.indexOf("https://webflow.com") >= 0 && (l = l.replace("https://webflow.com", "https://formdata.webflow.com")),
                        f = `${l}/signFile`,
                        !!(a = t(g + " form")).length)
                            a.each(I)
                    }(),
                    !_ && !s && function() {
                        ...
                        let e = ".w-checkbox-input"
                          ...
                          , u = [["checkbox", e], ["radio", n]];
                        p.on("change", g + ' form input[type="checkbox"]:not(' + e + ")", n => {
                            t(n.target).siblings(e).toggleClass(r)
                        }
                        ),
                        p.on("change", g + ' form input[type="radio"]', i => {
                            t(`input[name="${i.target.name}"]:not(${e})`).map( (e, i) => t(i).siblings(n).removeClass(r));
                            let o = t(i.target);
                            !o.hasClass("w-radio-input") && o.siblings(n).addClass(r)
                        }
                        ),
                        u.forEach( ([e,n]) => {
                            p.on("focus", g + ` form input[type="${e}"]:not(` + n + ")", e => {
                                t(e.target).siblings(n).addClass(i),
                                t(e.target).filter(":focus-visible, [data-wf-focus-visible]").siblings(n).addClass(o)
                            }
                            ),
                            p.on("blur", g + ` form input[type="${e}"]:not(` + n + ")", e => {
                                t(e.target).siblings(n).removeClass(`${i} ${o}`)
                            }
                            )
                        }
                        )
                ...
                function I(e, o) {
                    ...
                    b && (s.wait = !1,
                    A(s),
                    p.on("undefined" != typeof turnstile ? "ready" : u, function() {
                        i(b, o, t => {
                            s.turnstileToken = t,
                            T(s)
                        }
                    ...
                    var v = s.form.attr("aria-label") || s.form.attr("data-name") || "Form";
                    !s.done.attr("aria-label") && s.form.attr("aria-label", v),
                    s.done.attr("tabindex", "-1"),
                    s.done.attr("role", "region"),
                    !s.done.attr("aria-label") && s.done.attr("aria-label", v + " success"),
                    s.fail.attr("tabindex", "-1"),
                    s.fail.attr("role", "region"),
                    !s.fail.attr("aria-label") && s.fail.attr("aria-label", v + " failure");
                    var y = s.action = a.attr("action");
                    if (s.handler = null,
                    s.redirect = a.attr("data-redirect"),
                    w.test(y)) {
                        s.handler = N;
                        return
                    }
                    if (!y) {
                        if (c) {
                            s.handler = (0,
                            n(6524).default)(T, h, r, F, P, S, m, C, A, c, R, t, l);
                            return
                        }
                        O()
                    }
                ...
                function S(e, n) {
                    ...
                    e.find(':input:not([type="submit"]):not([type="file"])').each(function(i, o) {
                        var u = t(o)
                          , a = u.attr("type")
                          , c = u.attr("data-name") || u.attr("name") || "Field " + (i + 1);
                        ...
                        if ("checkbox" === a)
                            ...
                            if (null === n[c] || "string" == typeof n[c])
                                return;
                            s = e.find('input[name="' + u.attr("name") + '"]:checked').val() || null
                        }
                        "string" == typeof s && (s = t.trim(s)),
                        n[c] = s,
                        r = r || function(t, e, n, r) {
                            var i = null;
                            return "password" === e ? i = "Passwords cannot be submitted." : t.attr("required") ? r ? y.test(t.attr("type")) && !E.test(r) && (i = "Please enter a valid email address for: " + n) : i = "Please fill out the required field: " + n : "g-recaptcha-response" === n && !r && (i = "Please confirm you’re not a robot."),
                            i
                        }(u, a, c, s)
                    }),
                    r
                ...
                function N(n) {
                    ...
                    o.FNAME = r[0],
                    o.LNAME = o.LNAME || r[1]);
                    var a = n.action.replace("/post?", "/post-json?") + "&c=?"
                      , c = a.indexOf("u=") + 2;
                    c = a.substring(c, a.indexOf("&", c));
                    var s = a.indexOf("id=") + 3;
                    o["b_" + c + "_" + (s = a.substring(s, a.indexOf("&", s)))] = "",
                    t.ajax({
                        url: a,
                        data: o,
                        dataType: "jsonp"
        ...
        3946: function(t, e, n) {
            ...
            let r = n(7087)
              ...
              , S = ({hasBoundaryNodes: t, reducedMotion: e}) => ({
                type: u,
                payload: {
                    hasBoundaryNodes: t,
                    reducedMotion: e
              ...
              , N = ({actionTypeId: t=r.ActionTypeConsts.GENERAL_START_ACTION, actionListId: e, actionItemId: n, eventId: i, allowEvents: o, immediate: u, testManual: a, verbose: c, rawData: s}) => ({
                type: l,
                payload: {
                    actionTypeId: t,
                    actionListId: e,
        ...
        1970: function(t, e, n) {
            ...
            let E = Object.keys(f.QuickEffectIds)
              , m = t => E.includes(t)
              , {COLON_DELIMITER: _, BOUNDARY_SELECTOR: b, HTML_ELEMENT: w, RENDER_GENERAL: O, W_MOD_IX: I} = f.IX2EngineConstants
              , {getAffectedElements: T, getElementId: A, getDestinationValues: S, observeStore: C, getInstanceId: x, renderHTMLElement: F, clearAllStyles: N, getMaxDurationItemIndex: R, getComputedStyle: P, getInstanceOrigin: L, reduceListToGroup: M, shouldNamespaceEventParameter: j, getNamespacedParameterId: D, shouldAllowMediaQuery: k, cleanupHTMLElement: B, clearObjectCache: G, stringifyTarget: U, mediaQueriesEqual: V, shallowEqual: X} = d.IX2VanillaUtils
                        ...
                        s.default)(n, (e, n) => {
                            ...
                            (function({logic: t, store: e, events: n}) {
                                ...
                                s.default)(v, (t, o) => {
                                    ...
                                    !V(l, c.mediaQueryKeys) && e.dispatch((0,
                                                ...
                                                !function({store: t, eventStateKey: e, eventTarget: n, eventId: r, eventConfig: o, actionListId: u, parameterGroup: a, smoothing: c, restingValue: s}) {
                                                    ...
                                                    m.forEach( ({element: e, key: n}) => {
                                                        ...
                                                        i.default)(o, "[0].actionItems[0]", {})
                                                          , {actionTypeId: l} = a
                                                          , d = (l === f.ActionTypeConsts.PLUGIN_RIVE ? 0 === (a.config?.target?.selectorGuids || []).length : W(l)) ? $(l)(e, a) : null
                                                          , p = S({
                                                            element: e,
                                                            actionItem: a,
                                                            elementApi: h
                                    ...
                                    (a.actionTypeId === f.ActionTypeConsts.GENERAL_START_ACTION || m(a.actionTypeId)) && ts({
                                        store: e,
                                        actionListId: v,
                                        eventId: s
                                    })
            ...
            function td({store: t, eventId: e, eventTarget: n, eventStateKey: r, actionListId: o, groupIndex: u=0, immediate: a, verbose: c}) {
                ...
                0 === u && g && u++;
                let y = (0 === u || 1 === u && g) && m(d.action?.actionTypeId) ? d.config.delay : void 0
                  , E = (0,
            ...
            function tp(t) {
                ...
                let {store: n, computedStyle: r, ...i} = t
                  ...
                  , {refState: _} = g[m] || {}
                  , b = h.getRefType(o)
                  , w = y.reducedMotion && f.ReducedMotionTypes[u.actionTypeId];
                if (w && s)
            ...
            function tg(t, e) {
                let {active: n, continuous: r, complete: i, elementId: o, actionItem: u, actionTypeId: a, renderType: c, current: s, groupIndex: l, eventId: f, eventTarget: d, eventStateKey: v, actionListId: g, isCarrier: y, styleProp: E, verbose: m, pluginInstance: _} = t
        ...
        8955: function(t, e, n) {
            ...
            let {MOUSE_CLICK: h, MOUSE_SECOND_CLICK: v, MOUSE_DOWN: g, MOUSE_UP: y, MOUSE_OVER: E, MOUSE_OUT: m, DROPDOWN_CLOSE: _, DROPDOWN_OPEN: b, SLIDER_ACTIVE: w, SLIDER_INACTIVE: O, TAB_ACTIVE: I, TAB_INACTIVE: T, NAVBAR_CLOSE: A, NAVBAR_OPEN: S, MOUSE_MOVE: C, PAGE_SCROLL_DOWN: x, SCROLL_INTO_VIEW: F, SCROLL_OUT_OF_VIEW: N, PAGE_SCROLL_UP: R, SCROLLING_IN_VIEW: P, PAGE_FINISH: L, ECOMMERCE_CART_CLOSE: M, ECOMMERCE_CART_OPEN: j, PAGE_START: D, PAGE_SCROLL: k} = s.EventTypeConsts
              , B = "COMPONENT_ACTIVE"
              ...
              , $ = X( ({element: t, nativeEvent: e}) => t.contains(e.target))
              , z = (0,
            u.default)([W, $])
              , H = (t, e) => {
                if (e) {
              ...
              , td = (t=!0) => ({
                ...Z,
                handler: K(t ? z : W, ta( (t, e) => e.isActive ? Q.handler(t, e) : e))
            })
              , tp = (t=!0) => ({
                ...Z,
                handler: K(t ? z : W, ta( (t, e) => e.isActive ? e : Q.handler(t, e)))
            });
            let th = {
                ...te,
                handler: (r = (t, e) => {
                    let {elementVisible: n} = e
                      ...
                      , {ixData: o} = i.getState()
                      , {events: u} = o;
                    return !u[r.action.config.autoStopEventId] && e.triggered ? e : r.eventTypeId === F === n ? (q(t),
                    {
                        ...e,
                        triggered: !0
                    }) : e
                ...
                [C]: {
                    ...
                    handler: ({store: t, element: e, eventConfig: n, nativeEvent: r, eventStateKey: i}, o={
                        ...
                        case s.EventBasedOn.VIEWPORT:
                            m = y ? Math.min(p, window.innerWidth) / window.innerWidth : Math.min(h, window.innerHeight) / window.innerHeight;
                            break;
                        ...
                        return E && (m > .95 || m < .05) && (m = Math.round(m)),
                        (u !== s.EventBasedOn.ELEMENT || b || b !== o.elementHovered) && (m = l ? 1 - m : m,
                        t.dispatch((0,
                        f.parameterChanged)(_, m))),
                        {
                            elementHovered: b,
                            clientX: p,
                            clientY: h,
                ...
                [P]: {
                    ...
                    handler: ({element: t, store: e, eventConfig: n, eventStateKey: r}, i={
                        ...
                        let {scrollLeft: o, scrollTop: u, scrollWidth: a, scrollHeight: c, clientHeight: l} = tr()
                          , {basedOn: d, selectedAxis: p, continuousParameterGroupId: h, startsEntering: v, startsExiting: g, addEndOffset: y, addStartOffset: E, addOffsetValue: m=0, endOffsetValue: _=0} = n;
        ...
        7718: function(t, e, n) {
            ...
            let r = n(7087)
              ...
              , m = (t, e) => {
                let n, r, i, u;
                let {position: a, parameterId: c, actionGroups: s, destinationKeys: l, smoothing: f, restingValue: h, actionTypeId: v, customEasingFn: y, skipMotion: E, skipToValue: m} = t
                  , {parameters: _} = e.payload
                  , b = Math.max(1 - f, .01)
                  , w = _[c];
                null == w && (b = 1,
                w = h);
                let O = d((Math.max(w, 0) || 0) - a)
                  , I = E ? m : d(a + O * b)
                  , T = 100 * I;
                if (I === a && t.current)
                    return t;
              ...
              , b = (t=Object.freeze({}), e) => {
                ...
                case c:
                    {
                        let {instanceId: n, elementId: r, actionItem: i, eventId: u, eventTarget: a, eventStateKey: c, actionListId: s, groupIndex: l, isCarrier: f, origin: d, destination: p, immediate: v, verbose: g, continuous: m, parameterId: _, actionGroups: b, smoothing: w, restingValue: O, pluginInstance: I, pluginDuration: T, instanceDelay: A, skipMotion: S, skipToValue: C} = e.payload
                          , {actionTypeId: x} = i
                          , F = y(x)
                          , N = E(F, x)
                          , R = Object.keys(p).filter(t => null != p[t] && "string" != typeof p[t])
                          , {easing: P} = i.config;
                        return (0,
                        o.set)(t, n, {
                            id: n,
        ...
        4124: function(t, e, n) {
            ...
            let {BACKGROUND: h, TRANSFORM: v, TRANSLATE_3D: g, SCALE_3D: y, ROTATE_X: E, ROTATE_Y: m, ROTATE_Z: _, SKEW: b, PRESERVE_3D: w, FLEX: O, OPACITY: I, FILTER: T, FONT_VARIATION_SETTINGS: A, WIDTH: S, HEIGHT: C, BACKGROUND_COLOR: x, BORDER_COLOR: F, COLOR: N, CHILDREN: R, IMMEDIATE_CHILDREN: P, SIBLINGS: L, PARENT: M, DISPLAY: j, WILL_CHANGE: D, AUTO: k, COMMA_DELIMITER: B, COLON_DELIMITER: G, BAR_DELIMITER: U, RENDER_TRANSFORM: V, RENDER_GENERAL: X, RENDER_STYLE: W, RENDER_PLUGIN: $} = a.IX2EngineConstants
              , {TRANSFORM_MOVE: z, TRANSFORM_SCALE: H, TRANSFORM_ROTATE: Y, TRANSFORM_SKEW: q, STYLE_OPACITY: K, STYLE_FILTER: Q, STYLE_FONT_VARIATION: Z, STYLE_SIZE: J, STYLE_BACKGROUND_COLOR: tt, STYLE_BORDER: te, STYLE_TEXT_COLOR: tn, GENERAL_DISPLAY: tr, OBJECT_VALUE: ti} = a.ActionTypeConsts
              , to = t => t.trim()
              , tu = Object.freeze({
                [tt]: x,
                [te]: F,
            ...
            function tE({config: t, event: e, eventTarget: n, elementRoot: r, elementApi: i}) {
                ...
                if (!m)
                    return [];
                let {id: _, objectId: b, selector: w, selectorGuids: O, appliesTo: I, useEventTarget: T} = ty(m);
                if (b)
                ...
                let A = (e?.action?.config?.affectedElements ?? {})[_ || w] || {}
                  , S = !!(A.id || A.selector)
                  , C = e && f(ty(e.target));
                if (S ? (o = A.limitAffectedElements,
                u = C,
                c = f(A)) : u = c = f({
                    id: _,
                    selector: w,
            ...
            function tm({element: t, actionItem: e}) {
                if (!d.IS_BROWSER_ENV)
                    return {};
            ...
            let t_ = /px/
              , tb = (t, e) => e.reduce( (t, e) => (null == t[e.type] && (t[e.type] = tR[e.type]),
            t), t || {})
              , tw = (t, e) => e.reduce( (t, e) => (null == t[e.type] && (t[e.type] = tP[e.type] || e.defaultValue || 0),
            t), t || {});
                ...
                case J:
                    {
                        ...
                        let a = u(t, S)
                          , c = u(t, C);
                        return e = i.config.widthUnit === k ? t_.test(a) ? parseFloat(a) : parseFloat(n.width) : (0,
                        r.default)(parseFloat(a), parseFloat(n.width)),
                        {
                            widthValue: e,
                            heightValue: o = i.config.heightUnit === k ? t_.test(c) ? parseFloat(c) : parseFloat(n.height) : (0,
            ...
            function tC(t) {
                return /^TRANSFORM_/.test(t) ? V : /^STYLE_/.test(t) ? W : /^GENERAL_/.test(t) ? X : /^PLUGIN_/.test(t) ? $ : void 0
            }
            function tx(t, e) {
                return t === W ? e.replace("STYLE_", "").toLowerCase() : null
            }
            function tF(t, e, n, r, o, u, a, c, s) {
                switch (c) {
                case V:
                    return function(t, e, n, r, i) {
                        ...
                        function({actionTypeId: t}, {xValue: e, yValue: n, zValue: r}) {
                            return t === z && void 0 !== r || t === H && void 0 !== r || t === Y && (void 0 !== e || void 0 !== n)
                        }(r, n) && u(t, d.TRANSFORM_STYLE_PREFIXED, w)
                    }(t, e, n, o, a);
                case W:
            ...
            function tU({actionList: t={}, event: e, elementApi: n}) {
            ...
            function tJ(t) {
                ...
                if (t.pluginElement && t.objectId)
                    return t.pluginElement + U + t.objectId;
                if (t.objectId)
                    return t.objectId;
            ...
            Webflow.require("ix2").init({
                events: {
                    ...
                    "e-3": {
                        ...
                        target: {
                            id: "67b72b725d52db126010b66e|cb1fbf83-155a-8a26-2403-2f2cca689514",
                            appliesTo: "ELEMENT",
                            styleBlockIds: []
                        },
                        targets: [{
                        ...
                        actionItemGroups: [{
                            actionItems: [{
                                ...
                                config: {
                                    ...
                                    duration: 6e3,
                                    target: {
                                        id: "67b4a3fdf4b5c4d1c1a1198a|cf5ea6fc-5e87-0953-9013-bb5a30cd49a4"
                                    },
                                    widthValue: 200,
                                    widthUnit: "px",
                                    heightUnit: "PX",
                                ...
                                config: {
                                    ...
                                    duration: 2e3,
                                    target: {
                                        id: "67b4a3fdf4b5c4d1c1a1198a|5ba64856-cfa8-11d6-6f65-45f300554c8c"
                                    },
                                    filters: [{
                                        type: "brightness",
                                        filterId: "1501",
                            ...
                            actionItems: [{
                                ...
                                config: {
                                    ...
                                    target: {
                                        ...
                                        selectorGuids: ["f759535d-334f-2bae-cab5-1829c45fde78"]
                                    },
                                    heightValue: 372,
                                    widthUnit: "PX",
                                    heightUnit: "px",
                            ...
                            actionItems: [{
                                ...
                                config: {
                                    ...
                                    target: {
                                        ...
                                        selectorGuids: ["f95d7f4c-b916-305c-dc3a-eb7f5d2d09a8"]
                                    },
                                    value: "block"
                                }
                            }]
